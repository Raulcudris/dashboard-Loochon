...
export const AddCoordenatesModal: React.FC<AddCoordenatesModalProps> = ({
  ...
  const handleSave = async () => {
    ...
    if (!newCoordenate.sisNombreSipr.trim()) {
      alert('Por favor, complete el campo de Nombre de la Provincia.');
      return;
    }

    try {
      await createCity(newCoordenate);
      alert('Coordenada creada con éxito.');
      ...
      alert('Error al crear la coordenada. Por favor, inténtelo de nuevo.');
    }
  };
